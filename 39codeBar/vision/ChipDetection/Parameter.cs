...
namespace ChipDetection
{
    ...
    public class Parameter:ICloneable
    {
        ...
        private double mMotorStartRate;
        private double mMotorStopRate;
        private double mMotorRateDecreaseValue;
        private double mMotorFastRateDecreaseValue;
        private int mMotorRateTestInterval;
        private int mMotorAutoStopInterval;
        private int mStepLenMinPer;
        private int mStepLenMaxPer;
       ...
       // private ChipTemplate mChipTemplate;
        ...
        public int StepLenMinPer{
            get { return mStepLenMinPer; }
            set { mStepLenMinPer = value; }
        }
        public int StepLenMaxPer
        {
            get { return mStepLenMaxPer; }
            set { mStepLenMaxPer = value; }
        }
        ...
        public double MotorStartRate
        {
            get { return mMotorStartRate; }
            set { mMotorStartRate = value; }
        }
        public double MotorStopRate
        {
            get { return mMotorStopRate; }
            set { mMotorStopRate = value; }
        }
        ...
        public double MotorFastRateDecreaseValue
        {
            get { return mMotorFastRateDecreaseValue; }
            set { mMotorFastRateDecreaseValue = value; }
        }
        ...
        public void LoadOptionFile()
        {
           ...
           // int serialPort;
            ...
            {
                mMotorRateThreshold = 10;
                System.Console.Out.WriteLine(ex.Message);
            }
            try
            {
                mMotorStartRate = Convert.ToDouble(AccessIniFile.ReadValue(mOptionFile, "Motor", "StartRate"));
            }
            catch (System.Exception ex)
            {
                mMotorStartRate = 0.7;
            ...
            try
            {
                mMotorStopRate = Convert.ToDouble(AccessIniFile.ReadValue(mOptionFile, "Motor", "StopRate"));
            }
            catch (System.Exception ex)
            {
                mMotorStopRate = 0.5;
            ...
            {
                mMotorRateDecreaseValue = 0.01;
                System.Console.Out.WriteLine(ex.Message);
            }
            try
            {
                mMotorFastRateDecreaseValue = Convert.ToDouble(AccessIniFile.ReadValue(mOptionFile, "Motor", "FastRateDecreaseValue"));
            }
            catch (System.Exception ex)
            {
                mMotorFastRateDecreaseValue = 2;
                System.Console.Out.WriteLine(ex.Message);
            }
            try
            {
            ...
            try
            {
                mStepLenMinPer = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Motor", "StepLenMinPer"));
            }
            catch (System.Exception ex)
            {
                mStepLenMinPer = 5;
            ...
            try
            {
                mStepLenMaxPer = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Motor", "StepLenMaxPer"));
            }
            catch (System.Exception ex)
            {
                mStepLenMaxPer = 7;
           ...
           // Rectangle objectRectangle = new Rectangle();
            ...
            try
            {
                ...
                DefaultTemplateFile = mAssemblyPath + (AccessIniFile.ReadValue(mOptionFile, "Template", "DefaultPhotoFile"));
            }
            catch (System.Exception ex)
            {
                DefaultTemplateFile = mAssemblyPath + "template.bmp";
                System.Console.Out.WriteLine(ex.Message);
            }
            //AreaRatio
            try
            {
                ...
                AreaRatio = Convert.ToDouble(AccessIniFile.ReadValue(mOptionFile, "Template", "AreaRatio"));
            }
            catch (System.Exception ex)
            {
                AreaRatio = 1.5;
            ...
            try
            {
                FeatureLeft = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "FeatureLeft"));
            }
            catch (System.Exception ex)
            {
                FeatureLeft = 1;
            ...
            try
            {
                FeatureTop = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "FeatureTop"));
            }
            catch (System.Exception ex)
            {
                FeatureTop = 1;
            ...
            try
            {
                FeatureWidth = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "FeatureWidth"));
            }
            catch (System.Exception ex)
            {
                FeatureWidth = 10;
            ...
            try
            {
                FeatureHeight = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "FeatureHeight"));
            }
            catch (System.Exception ex)
            {
                FeatureHeight = 10;
            ...
            try
            {
                ObjectLeft = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "ObjectLeft"));
            ...
            try
            {
                ObjectTop = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "ObjectTop"));
            }
            catch (System.Exception ex)
            {
                ObjectTop = 1;
            ...
            try
            {
                ObjectWidth = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "ObjectWidth"));
            }
            catch (System.Exception ex)
            {
                ObjectWidth = 10;
            ...
            try
            {
                ObjectHeight = Convert.ToInt32(AccessIniFile.ReadValue(mOptionFile, "Template", "ObjectHeight"));
            }
            catch (System.Exception ex)
            {
                ObjectHeight = 10;
